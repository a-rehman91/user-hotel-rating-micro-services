package com.ms.user.service.configuration;

import com.ms.user.service.configuration.interceptor.RestTemplateInterceptor;
...
public class MyConfig {
    ...
    // Declare the bean of OAuth2AuthorizedClientManage
    @Bean
